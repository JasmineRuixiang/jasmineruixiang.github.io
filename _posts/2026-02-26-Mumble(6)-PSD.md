...
On the other hand, notice that at a point $$A \in \mathrm{SPD}(n)$$,
...
the space of symmetric matrices. So tangent vectors are symmetric matrices $$H,K$$.

Then, because of invariance, it suffices to define the metric at $$I$$ (echoeing the definition of Lie derivative). At $$I$$, the most natural inner product on symmetric matrices is the Frobenius one:
