...
But $$V = \gamma^{-1}(t) \dot{\gamma}(t)$$, so we get:

$$
\gamma^{-1}(t) \dot{\gamma}(t) = X.
$$

Multiply both sides by $$\gamma (t)$$:
...
- Motion with constant “Lie algebra velocity” is straight
...
This is the cleanest intuition.
