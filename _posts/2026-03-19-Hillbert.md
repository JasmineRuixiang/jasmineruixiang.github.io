...
Association with finite dimensional matrices? --- shadows of finite dimensional matrices into the infinite dimensional space. 
...
### 5.2] Operator Categorizations
Based on the adjoint operator $$T^*$$ defined as the following:

$$
\langle Tx, y \rangle = \langle x, T^*y \rangle
$$

* Self-adjoint: Physical intuition
* Unitary
* Compact 
* Positive
...
For any continuous functional $$\phi$$, it could be written in the following format: 

* $$\phi(x) = \langle x, y \rangle, \;\; \forall x \in H$$ for some $$y \in H$$. 

This theorem reveals a deeper property of Hillbert space other than the completeness and inner product we illustrated above: self-duality. 

Based on self-duality, we immediately observe that 

$$
H \cong H^*
$$

Intuitively, this means that "measurements" about the space acquires the same structure as the underlying Hillbert space itself: connotations for quntum mechanics. 
