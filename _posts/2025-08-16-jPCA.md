...
### Relation with Lie group and Lie algebra
...
More explanations on the normal matrices. 

> Def: A normal matrix is a matrix that commutes with its adjoint: $$[A, A^{\dagger}] = 0$$

Note that Hermitian and unitary matrices are special cases of 
