...
title: Music
permalink: /music/
description: A collection of my music pieces and compositions.
nav: true
nav_order: 3
---
...
<div class="row mb-5">
  <div class="col-sm-12">
    <h2 class="category">All Tracks</h2>
    <hr>
    <iframe 
      width="100%" 
      height="450" 
...
<!-- Highlighted Pieces Gallery from YAML -->
{% if site.data.music and site.data.music.size > 0 %}
<div class="row">
  <div class="col-sm-12">
    <h2 class="category">Highlighted Pieces</h2>
    <hr>
  </div>
</div>
